...
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int {
    val departMinutes = hoursDepart * 60 + minutesDepart
    val arriveMinutes = hoursArrive * 60 + minutesArrive
    return arriveMinutes - departMinutes
}
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val first = initial * percent * 0.01 + initial
    val second = first * percent * 0.01 + first
    return second * percent * 0.01 + second
}
